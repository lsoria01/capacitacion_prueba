...
class CursoSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('curso')->insert(['nombre'=>'Verificacion', 'fecha_inicio' => '2022-06-01', 'fecha_fin' => '2024-01-01', 'cursoOblig' => '1', 'hrsCap' => '20', 'cursoIntExt' => '1', 'difundidoDP' => '1', 'modalidad' => 'presencial', 'id_estatus' => '2', 'id_institucion' => '1', 'folio' => 'VERIF22' ]);
        ...
        DB::table('curso')->insert(['nombre'=>'Curso básico de derechos humanos' , 'fecha_inicio' => '2022-06-01', 'fecha_fin' => '2023-03-30','cursoOblig' => '1', 'hrsCap' => '22', 'cursoIntExt' => '1', 'difundidoDP' => '1', 'modalidad' => 'presencial', 'id_estatus' => '2','id_institucion' => '6', 'folio' => 'CBDH23' ]);
