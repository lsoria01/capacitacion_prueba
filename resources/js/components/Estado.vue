          ...
          <!-- Right aligned nav items -->
                    <b-navbar-nav class="ml-auto">
                      <b-nav-item-dropdown v-if="rol == 1" text="Catálogos" class="mr-4" right>
                            ...
                            <b-dropdown-item class="activo active" v-if="rol == 1" href="/estados">Estados</b-dropdown-item>
                      ...
                      <b-row>
                        <b-col cols="12" lg="12">
                          <b-form-group
                              ...
                              label-size="sm" 
                              label="Nombre:">
                              <b-form-input id="nombre" size="sm" name="nombre" v-model="estado.nombre" style="text-transform:uppercase" autocomplete="off" required>
                              </b-form-input>
                          </b-form-group>
                        </b-col>
                      </b-row>
                      ...
                      <b-row>
                        <b-col cols="12" lg="12">
                          <b-form-group
                              ...
                              label-size="sm" 
                              label="Nombre:">
                              <b-form-input id="nombre" size="sm" name="nombre" v-model="estado_.nombre" style="text-transform:uppercase" autocomplete="off">
                              </b-form-input>
                          </b-form-group>
                        </b-col>
                      </b-row>
            ...
            <b-container fluid>
                ...
                <template #cell(actions)="row">
                  <b-button size="sm" class="botones" @click="cargarDatos(row.item)" v-b-modal.modal-editar 
                    v-b-tooltip.hover title="Haga click si desea editar el estado">
