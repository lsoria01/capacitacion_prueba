            ...
            <b-modal centered id="modal-crear" title="Nuevo Estado" hide-footer>
                    <b-form @submit.prevent="crear">
                      <b-row>
                        <b-col cols="12">
                          <label>Nombre:</label>
                          <b-form-input id="nombre" name="nombre" v-model="estado.nombre" style="text-transform:uppercase" required>
                          </b-form-input>
                        </b-col>
                      </b-row>
            ...
            <b-modal centered id="modal-editar" title="Editar Estado" hide-footer>
                    <b-form @submit.prevent="editar(estado_)">
                      <b-row>
                        <b-col cols="12">
                          <label>Nombre:</label>
                          <b-form-input id="nombre" name="nombre" v-model="estado_.nombre" style="text-transform:uppercase">
                          </b-form-input>
                        </b-col>
                      </b-row>
                      <b-row class="mt-4 mb-4">
