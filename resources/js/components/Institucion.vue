          ...
          <!-- Right aligned nav items -->
                    <b-navbar-nav class="ml-auto">
                      <b-nav-item-dropdown v-if="rol == 1" text="Catálogos" class="mr-4" right>
                            ...
                            <b-dropdown-item class="activo active" v-if="rol == 1" href="/instituciones">Instituciones</b-dropdown-item>
            ...
            <b-container fluid>
                ...
                <template #cell(actions)="row">
                  <b-button size="sm" class="botones" @click="cargarDatos(row.item)" v-b-modal.modal-editar 
                    v-b-tooltip.hover title="Haga click si desea editar la Institución">
